...
plot(Div.t_vec/t_c,Div.ke_total/Div.ke_total(1),'LineWidth',2,'LineStyle','-','color','black')
...
plot(Div_F4.t_vec/t_c,Div_F4.ke_total/Div_F4.ke_total(1),'LineWidth',2,'LineStyle','--','color',[0.4660, 0.6740, 0.1880])
...
xlim([0 1*2*pi])
pbaspect([1.8 1 1])
legend('KGP','Div','Shima','HLLC','KGP w/P','Div w/F4','Div w/F2')
...
Div_F4.dKe   = -gradient(Div_F4.ke_total,Div_F4.t_vec);
Div_F2.dKe   = -gradient(Div_F2.ke_total,Div_F2.t_vec);
Shima.dKe = -gradient(Shima.ke_total,Shima.t_vec);
HLLC.dKe  = -gradient(HLLC.ke_total,HLLC.t_vec);
KGP_P.dKe = -gradient(KGP_P.ke_total,KGP_P.t_vec);
...
hold on
plot(Div.t_vec/t_c,Div.dKe,'LineWidth',2,'LineStyle','--','color','black')
...
plot(Div_F4.t_vec/t_c,Div_F4.dKe,'LineWidth',2,'LineStyle','--','color',[0.4660, 0.6740, 0.1880])
plot(Div_F2.t_vec/t_c,Div_F2.dKe,'LineWidth',2,'LineStyle',':','color',[0.6350 0.0780 0.1840])
...
xlim([0 5])
pbaspect([1.8 1 1])
legend('KGP','Div','Shima','KGP w/P','Div w/F4','Div w/F2')
legend('Location','northeast','box','off')

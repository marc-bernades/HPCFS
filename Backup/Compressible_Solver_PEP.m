function [u,v,w,E,rho,mu,kappa,c_v,c_p,P,T,ke,e,sos,Beta_T, Beta_v, Beta_s, Alpha_p,time,t_vec,ke_total,X,Y,Z, Invariants] = Compressible_Solver_PEP(Fluid,bSolver,x_0,y_0,z_0,L_x,L_y,L_z,t_0,t_end,name_file_out,...
...
[grid_mesh, rho, u, v, w, E, rhou, rhov, rhow, rhoE, rhoe, P, T, mu, kappa, sos, rhou_0, rhov_0, rhow_0, rhoE_0, rhoe_0, ...
...
[rho,e,~,E,~,~,~,~,~, ~, ~, ~]    = Initialize_Thermodynamics(bSolver, P,T,u,v,w,bPressureModel,Fluid,Substance);
...
%                 Pu_conv   = Calculate_Convective_Split(C_D{7}, C_u{7}, C_fi{7}, C_rho{7}, C_L{7}, scheme.p);
                ...
                rhoe_conv = rhoe_conv + Pu_conv;
                rhoE_conv = rhoe_conv + rhok_conv;

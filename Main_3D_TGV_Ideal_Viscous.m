...
if strcmp(bSolver,'Ideal')
    ...
    Fluid.Re          = 1600;                   % Refer AMR 2019
    Fluid.D_0         = 1;                      % Reference length
    Fluid.mu_0        = Fluid.rho_0*Fluid.D_0*Fluid.U_0/Fluid.Re;              % Dynamic viscosity of the fluid [Pa s]
...
t_c           = 100; %max([L_x,L_y,L_z])/Fluid.U_0; % Reference time
t_end         = t_c;                      % Final time [s]
Test          = '3D_TGV_Viscous';                   % Test assessment for Initial conditions
...
output_iter = [2 5 10 15 20 25 30 40 50 60 80 90 100];                  % Output data every output_iter
